...
const CustomCheckbox = withStyles({
  ...
  return <Checkbox color="default" {...props}></Checkbox>;
});
    ...
    <Container className={classes.root}>
      ...
      <div className={classes.item}>
        <Typography variant="h6">
          2. Checkboxes with FormControlLabel
        </Typography>
        ...
        <FormGroup row>
          ...
          />
          <FormControlLabel
            control={<Checkbox disabled color="default" />}
            label="Disabled"
          />
          <FormControlLabel
            control={<Checkbox defaultChecked disabled color="default" />}
            label="Disabled"
          />
          <FormControlLabel
            control={<Checkbox defaultChecked indeterminate color="primary" />}
            label="Indeterminate"
          />
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                icon={<FavoriteBorderSharp />}
                checkedIcon={<FavoriteSharp />}
                defaultChecked
                color="secondary"
              />
            }
